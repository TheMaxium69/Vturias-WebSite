...
<main id="legal">
    <section id="projet">
        ...
        <p style="font-size: 20px; text-align: center" class="container">Retrouvez ici toutes les informations légal sur Vturias.</p>
        <br>
        ...
        <div id="info" class="container" style="text-align: start;">
            ...
            <div class="row">
                <div class="col-6 textmore">
                    <h3 style="margin-bottom: 12px; margin-top: 20px; color:var(--color-secondary)">Remerciements</h3>
...
<!--                    <small>- TyroButton-0.0.1-Private</small><br>-->
                    ...
                    <small>- FontAwesome-6.5.1</small><br>
                    <small>- JQuery-3.4.1</small><br>
                    <small>- FullPage.js-2.7.4</small><br>
                    <small>- Animate.css-3.5.2</small><br>
...
<!--                    <small>- Google reCAPTCHA</small><br>-->
            ...
            <div class="row">
                ...
                <div style="text-align: start">
                    ...
                    <h3 style="color: var(--color-secondary)">1. Acceptation des CGU</h3>
                    ...
                    <h3 style="color: var(--color-secondary)">2. Utilisation du Site</h3>
                    ...
                    <h3 style="color: var(--color-secondary)">3. Propriété intellectuelle</h3>
                    ...
                    <h3 style="color: var(--color-secondary)">4. Limitation de responsabilité</h3>
                    ...
                    <h3 style="color: var(--color-secondary)">5. Liens externes</h3>
                    ...
                    <h3 style="color: var(--color-secondary)">6. Modification des CGU</h3>
                    ...
                    <h3 style="color: var(--color-secondary)">7. Droit applicable et juridiction compétente</h3>
